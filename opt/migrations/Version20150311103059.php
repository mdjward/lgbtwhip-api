...
class Version20150311103059 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE views (view_id INT NOT NULL, candidate_id INT DEFAULT NULL, issue_id INT DEFAULT NULL, historic_stance LONGTEXT NOT NULL, current_stance LONGTEXT NOT NULL, INDEX IDX_11F09C8791BD8781 (candidate_id), INDEX IDX_11F09C875E7AA58C (issue_id), PRIMARY KEY(view_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE parties (party_id INT NOT NULL, name VARCHAR(255) NOT NULL, logo LONGBLOB DEFAULT NULL, website_url VARCHAR(255) NOT NULL, colour VARCHAR(10) NOT NULL, INDEX name (name), PRIMARY KEY(party_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE terms (term_id INT NOT NULL, candidate_id INT NOT NULL, party_id INT DEFAULT NULL, start_date DATE NOT NULL, end_date DATE DEFAULT NULL, INDEX IDX_88A23F7191BD8781 (candidate_id), INDEX IDX_88A23F71213C1059 (party_id), PRIMARY KEY(term_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
